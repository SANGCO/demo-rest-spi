...
import me.sangco.demorestspi.accounts.CurrentUser;
import me.sangco.demorestspi.common.ErrorsResource;
...
public class EventController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity updateEvent(@PathVariable Integer id, @RequestBody @Valid EventDto eventDto, Errors errors, @CurrentUser Account currentUser) {        Optional<Event> optionalEvent = this.eventRepository.findById(id);
        if(optionalEvent.isEmpty()) {
            return ResponseEntity.notFound().build();
        }
